    ...
    public partial class ClientesPage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                UpdateClientesCount();
                System.Diagnostics.Debug.WriteLine("*** ClientesPage OnAppearing - T�tulo actualizado ***");
        ...
        private void UpdateClientesCount()
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"*** ClientesPage - T�tulo actualizado: {Title} ***");
            }
            catch (Exception ex)
            {
